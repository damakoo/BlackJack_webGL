...
public class CardsList : MonoBehaviour
{
    ...
    public void InitializeCards()
    {
        ...
        GameObject myfieldcard = Instantiate(CardPrefab, MyFieldCardtransform.position, Quaternion.Euler(new Vector3(0,0, -90)), CardsListParent.transform);
        myfieldcard.name = "MyFieldCard";
        MyFieldCard = myfieldcard.AddComponent<CardState>().Initialize(myfieldcard, true);
